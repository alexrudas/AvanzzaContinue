...
abstract class PurchaseRepository {
  // Requests
  Stream<List<PurchaseRequestEntity>> watchRequestsByOrg(String orgId, {String? cityId, String? assetId});
  Future<List<PurchaseRequestEntity>> fetchRequestsByOrg(String orgId, {String? cityId, String? assetId});
  ...
  Future<List<SupplierResponseEntity>> fetchResponsesByRequest(String requestId);
