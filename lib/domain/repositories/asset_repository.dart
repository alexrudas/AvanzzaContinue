...
abstract class AssetRepository {
  // Assets root
  Stream<List<AssetEntity>> watchAssetsByOrg(String orgId, {String? assetType, String? cityId});
  Future<List<AssetEntity>> fetchAssetsByOrg(String orgId, {String? assetType, String? cityId});
  ...
  Future<({AssetVehiculoEntity? vehiculo, AssetInmuebleEntity? inmueble, AssetMaquinariaEntity? maquinaria})> getAssetDetails(String assetId);
  ...
  // Documents
  Stream<List<AssetDocumentEntity>> watchAssetDocuments(String assetId, {String? countryId, String? cityId});
  Future<List<AssetDocumentEntity>> fetchAssetDocuments(String assetId, {String? countryId, String? cityId});
