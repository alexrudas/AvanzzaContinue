...
mixin _$UserProfileEntity {
  ...
  @override
  String toString() {
    return 'UserProfileEntity(uid: $uid, phone: $phone, countryId: $countryId, cityId: $cityId, roles: $roles, orgIds: $orgIds, status: $status, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
}
