...
abstract class ProviderProfile with _$ProviderProfile {
  const factory ProviderProfile({
    ...
    @Default(<String>[]) List<String> assetTypeIds, // ['vehiculos','inmuebles','maquinaria','equipos','otros']
    required String businessCategoryId,           // ej: 'lubricentro' | 'mecanico_independiente'
