...
// // PÁGINA PRINCIPAL
// // ============================================================================
// class AdminHomePageV2 extends StatelessWidget {
//   const AdminHomePageV2({super.key});
...
//         onTap: () async {
//           // Ejecuta formulario del runt vehículos
...
//                   color: _DesignSystem.colors.surfaceVariant.withValues(alpha: 0.5),
//                   borderRadius: BorderRadius.circular(12),
//                 ),
//                 child: Icon(
//                   icon,
...
//                     _DesignSystem.colors.background.withValues(alpha: 0),
//                   ],
//                 ),
//               ),
//             ),
...
//                     BoxShadow(
//                       color:
//                           _DesignSystem.colors.shadow.withValues(alpha: 0.15),
//                       blurRadius: 8,
...
// // // ============================================================================
// // class _IndicadoresGestion extends StatefulWidget {
// //   const _IndicadoresGestion();

// //   @override
// //   State<_IndicadoresGestion> createState() => _IndicadoresGestionState();
// // }

// // class _IndicadoresGestionState extends State<_IndicadoresGestion> {
// //   bool _expanded = false;
...
// //             secondChild: const _IndicadoresGestionContent(),
...
// // class _IndicadoresGestionContent extends StatelessWidget {
// //   const _IndicadoresGestionContent();
...
// //                           ? _DesignSystem.colors.success.withValues(alpha: 0.15)
// //                           : _DesignSystem.colors.error.withValues(alpha: 0.15),
// //                       borderRadius: BorderRadius.circular(8),
// //                     ),
// //                     child: Row(
// //                       mainAxisSize: MainAxisSize.min,
...
//   Widget build(BuildContext context) {
//     return _GlassCard(
//       // 1. Quitamos el padding de aquí (o lo ponemos en zero) para que el hijo ocupe todo
...
//           // 2. Movemos el Padding aquí adentro.
//           // Ahora el InkWell incluye el espacio vacío en su área táctil.
//           child: Padding(
//             padding: const EdgeInsets.all(16),
//             child: Row(
//               children: [
...
//                     boxShadow: [
//                       BoxShadow(
//                         color: _DesignSystem.colors.primary.withValues(alpha: 0.3),
//                         blurRadius: 12,
//                         offset: const Offset(0, 4),
//                       ),
//                     ],
...
//             gradient: LinearGradient(
//               colors: [
//                 _DesignSystem.colors.info.withValues(alpha: 0.1),
//                 _DesignSystem.colors.info.withValues(alpha: 0.05),
//               ],
//             ),
//             borderRadius: BorderRadius.circular(16),
//             border: Border.all(
//               color: _DesignSystem.colors.info.withValues(alpha: 0.3),
//               width: 1.5,
//             ),
//           ),
//           child: Row(
