        ...
        child: Obx(() => Column(
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: _regions,
                  decoration:
                      const InputDecoration(labelText: 'Región (opcional)'),
                  onChanged: (v) async {
                    setState(() {
                      _regionId = v;
                      _cityId = null;
                    ...
                    if (_countryId != null)
                      await _loadCities(_countryId!, _regionId);
                  },
                ),
                const SizedBox(height: 8),
                DropdownButtonFormField<String>(
                ...
                ElevatedButton(
                  onPressed: (_countryId != null && _cityId != null)
                      ? () async {
                          ...
                          // Explorar sin fricción: país → titular → rol
